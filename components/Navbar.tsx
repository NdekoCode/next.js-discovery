      ...
      >
        <div className="flex flex-col mt-5 gap-y-4 gap-x-0 sm:flex-row sm:items-center sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7 lg:ml-10">
          <Link href="/blog" aria-current="page">
            <a className="font-medium text-blue-600 sm:py-6 dark:text-blue-500">
              Blog
            </a>
          </Link>
          <Link href="/about">
          ...
          <div className="flex items-center gap-x-2 sm:ml-auto">
            <Link href="/auth/login">
              <a className="flex items-center font-medium text-gray-500 gap-x-2 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500">
                <svg
                  className="w-4 h-4"
